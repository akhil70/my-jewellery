      ...
      <Container>
        <Row className='g-4'>
          ...
          <Col xs={12} md={3}>
            ...
            <hr />
            <p className='footer-text'>
              <Link to='/'>Weekdays in Kerala</Link>
              <p>03th Dec 2021</p>
            </p>
            <hr />
          </Col>
          <Col xs={12} md={3}>
            ...
            <p className='footer-text'>
              250 Main Street, Banglure, NY 52143, IND
            </p>
            <p className='footer-text'>
              <i className='fas fa-phone-alt ico'></i>
              Tell <span className='number'>0481-95668</span>
            </p>
            <p className='footer-text'>
            ...
            <p className='footer-text'>
              ...
              Website <span className='number'> jewellershop.com</span>
            </p>
