    ...
    <div className='Slider'>
      <Carousel className='text-left carousel'>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <p className='slider-textt subtitle'>AMAZING FROM JEWELRY</p>
            <h3 className='slider-title'>Discover Night Paris</h3>
            <p className='slider-text'>Discount 30% Off For Couples</p>
            <Button className='px-4 py-3 rounded-pill mt-4' variant='warning'>
              BOOK YOUR TRAVEL
            </Button>
          </Carousel.Caption>
        </Carousel.Item>
